...
static const _ThreeNumbers_type_support_symbol_names_t _ThreeNumbers_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, test_2_interfaces, msg, ThreeNumbers)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, test_2_interfaces, msg, ThreeNumbers)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, test_2_interfaces, msg, ThreeNumbers)() {
  return &::test_2_interfaces::msg::rosidl_typesupport_c::ThreeNumbers_message_type_support_handle;
}
